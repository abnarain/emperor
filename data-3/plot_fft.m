...
% Calculates the signal values and the sampling frequency
% Plots the single sided and double sided FFT
% Input : file name containing time, signal in csv format
% Optional input: flag=1 generates double sided FFT image
% plotfilename= prints out a pdf file with the FFT in it
r1= csvread(filename);
signal1=r1(:,2);
time1=r1(:,1);
